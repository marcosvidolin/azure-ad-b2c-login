...
You can visit `http://localhost:8080` and perform the following actions:
...
- Set the **Reply URL** for your app, for example `http://localhost:8080`. The sample provided in this repository is configured to run on port 8080.
